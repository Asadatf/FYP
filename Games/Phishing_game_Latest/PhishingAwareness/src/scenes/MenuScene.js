class MenuScene extends Phaser.Scene {
    ...
    create() {
        ...
        const titleText = this.add.text(400, 120, 'PHISHING DEFENSE', {
            fontSize: '48px',
        ...
        // Add subtitle
        const subtitleText = this.add.text(400, 180, 'SECURE YOUR NETWORK', {
            fontSize: '24px',
            fontFamily: 'Arial',
            fill: '#ffffff',
            stroke: '#000000',
        ...
        const buttonBg = this.add.rectangle(400, 320, 220, 60, 0x000000)
            .setStrokeStyle(2, 0x00ffff);
        
        const startButton = this.add.text(400, 320, 'START MISSION', {
            fontSize: '28px',
            fontFamily: 'Arial',
            fill: '#00ffff'
        })
        ...
        const instructionsBox = this.add.rectangle(400, 450, 600, 120, 0x000000, 0.6)
