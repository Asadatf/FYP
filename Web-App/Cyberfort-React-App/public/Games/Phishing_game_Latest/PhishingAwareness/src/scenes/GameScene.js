class GameScene extends Phaser.Scene {
  ...
  createUI() {
    ...
    this.uiPanel = this.add
      .rectangle(400, 30, 780, 50, 0x000000, 0.7)
    ...
    this.timeText = this.add
      .text(784, 30, "Time: " + this.timeLeft, {
        fontSize: "24px",
        fontFamily: "Arial",
        fill: "#00ffff",
      })
    ...
    this.threatLevel = this.add
      .text(400, 580, "THREAT LEVEL: 1", {
        fontSize: "16px",
        fontFamily: "Arial",
        fill: "#ff3333",
      })
    ...
    this.messages = this.messages.filter((message) => {
      if (message && message.container && message.container.y > 650) {
        ...
        if (message.data.isPhishing) {
          ...
          const breach = this.add
            .text(message.container.x, 550, "BREACH!", {
              fontSize: "24px",
              fontFamily: "Arial",
              fill: "#ff0000",
              stroke: "#000",
