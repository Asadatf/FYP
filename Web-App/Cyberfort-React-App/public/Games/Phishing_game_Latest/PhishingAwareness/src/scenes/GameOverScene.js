class GameOverScene extends Phaser.Scene {
    ...
    create() {
        ...
        const panel = this.add.rectangle(400, 300, 500, 400, 0x000000, 0.8)
        ...
        const gameOver = this.add.text(400, 180, resultTitle, {
            fontSize: '40px',
        ...
        const scoreText = this.add.text(400, 250, 'FINAL SCORE: 0', {
            fontSize: '32px',
            fontFamily: 'Arial',
            fill: '#ffffff'
        }).setOrigin(0.5);
        ...
        const scoreCounter = this.time.addEvent({
            delay: 30,
            callback: () => {
                displayScore = Math.min(displayScore + Math.ceil(this.finalScore / 50), this.finalScore);
        ...
        const restartButton = this.add.rectangle(400, 400, 200, 50, 0x000000)
            .setStrokeStyle(2, 0x00ffff)
            .setInteractive({ useHandCursor: true });
            
        const restartText = this.add.text(400, 400, 'PLAY AGAIN', {
            fontSize: '24px',
            fontFamily: 'Arial',
            fill: '#00ffff'
        }).setOrigin(0.5);
        ...
        const menuButton = this.add.rectangle(400, 470, 200, 50, 0x000000)
            .setStrokeStyle(2, 0x00ffff)
            .setInteractive({ useHandCursor: true });
            
        const menuText = this.add.text(400, 470, 'MAIN MENU', {
            fontSize: '24px',
            fontFamily: 'Arial',
            fill: '#00ffff'
        }).setOrigin(0.5);
    ...
    displayRating(rating, color) {
        ...
        const ratingTitle = this.add.text(400, 320, 'SECURITY RATING', {
            fontSize: '24px',
            fontFamily: 'Arial',
            fill: '#ffffff'
        }).setOrigin(0.5);
        
        const ratingText = this.add.text(400, 350, rating, {
            fontSize: '72px',
