...
const ImprovedQuizAttempt = () => {
    ...
    const fetchQuizInfo = async () => {
      try {
        ...
        const response = await fetch(
          `https://fyp-backend-gamma-flax.vercel.app/api/quiz/getquiz/${quizId}`
        );
  ...
  const handleStartQuiz = async () => {
    ...
    try {
      ...
      const response = await fetch(
        "https://fyp-backend-gamma-flax.vercel.app/api/quiz/generate-quiz",
        {
          method: "POST",
          headers: {
  ...
  const SaveQuizScore = async () => {
    ...
    if (response.ok) {
      ...
      const res = await fetch(
        `https://fyp-backend-gamma-flax.vercel.app/api/quiz/savequiz?quizId=${quizInfo.id}&userId=${data.user.user_id}`,
        {
          method: "POST",
          headers: {
          ...
          body: JSON.stringify({
            // Make sure body is stringified JSON
  ...
  if (error) {
    return (
      ...
      >
        <div className="text-center">
          <div
            className="bg-danger-100 rounded-circle d-flex align-items-center justify-content-center mx-auto mb-16"
          ...
          <button
            ...
            className="btn btn-outline-primary rounded-pill px-24 py-12"
          >
  ...
  if (!quizInfo) {
    return (
      ...
      >
        <div className="text-center">
          <div
            className="bg-warning-100 rounded-circle d-flex align-items-center justify-content-center mx-auto mb-16"
            style={{ width: "80px", height: "80px" }}
          >
  ...
  if (showIntro) {
    const difficultyLevel =
      quizInfo.difficulty?.toLowerCase() || "intermediate";
                ...
                <div className="card-body p-0">
                  ...
                  >
                    <div className="d-flex justify-content-between align-items-center mb-16">
                      ...
                      >
                        {quizInfo.difficulty
                          ? quizInfo.difficulty.charAt(0).toUpperCase() +
                            quizInfo.difficulty.slice(1)
                          : "Intermediate"}
                      </div>
                      <div
                        className={`badge bg-white text-${difficultyColor}-600 px-12 py-8 rounded-pill`}
                      ...
                      <div className="d-flex gap-16">
                        ...
                        <div>
                          ...
                          <ul className="mb-0">
                            ...
                            <li className="mb-0">
                              Once you submit the quiz, you cannot change your
                              answers.
                            </li>
                          </ul>
                        </div>
    ...
    return (
      ...
      >
        <div className="text-center">
          ...
          <p className="mb-16 text-gray-600">
            The current question cannot be displayed.
          </p>
          <button
            onClick={handleReturnToDashboard}
            className="btn btn-outline-primary rounded-pill px-24 py-12"
          ...
          <div className="col-lg-10">
            ...
            <div className="card border-0 shadow-sm mb-24">
              <div className="card-body p-0">
                <div className="d-flex flex-column flex-md-row">
                  ...
                  >
                    <h5 className="text-main-800 mb-8">
                      {quiz.title || "Quiz"}
                    </h5>
            ...
            <div className="row">
                      ...
                      currentQuestion.explanation && (
                        <div className="explanation-container p-24 border border-info-200 rounded-4 bg-info-50 mb-32">
                          <div className="d-flex gap-16">
                            <div className="flex-shrink-0">
                              <div
                                className="bg-info-100 rounded-circle d-flex align-items-center justify-content-center"
                                style={{ width: "40px", height: "40px" }}
                              >
              ...
              <div className="col-lg-4">
                <div
                  className="card border-0 shadow-sm mb-24 sticky-top"
                  ...
                  <div className="card-body p-24">
                    <ul className="quiz-tips-list mb-0">
                      ...
                      <li className="d-flex gap-12">
                        ...
                        <p className="mb-0">
                          If you're unsure, try to eliminate obviously incorrect
                          options first.
                        </p>
                      </li>
                    </ul>
