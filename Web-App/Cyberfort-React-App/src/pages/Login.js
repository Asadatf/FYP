                  ...
                  <div className="login-register-form">
                    <form onSubmit={handleLoginSubmit}>
                      ...
                      <div className="form-btn">
                        <button type='submit' className="btn btn-main" disabled={isLoginLoading}>{isLoginLoading ? 'Logging in...' : 'Login'}</button>
                      </div>
                      <div className="single-form">
                    ...
                    <form onSubmit={handleSignupSubmit}>
                      ...
                      <div className="single-form">
                         <div style={{ position: 'relative' }}>
                          ...
                          <button
                            type="button"
                            onClick={() => setcsignupShowPassword(!csignupshowPassword)}
                            style={{
                              position: 'absolute',
                              right: '10px',
                              top: '50%',
                      ...
                      <div className="form-btn">
                        <button type='submit' className="btn btn-main" disabled={isSignupLoading}>{isSignupLoading ? 'Registering...' : 'Register'}</button>
                      </div>
                    </form>
                  </div>
                </div>
